...
export const seedPrompts = [
    {
        id: 'brand-lippi-summer-1',
        name: 'Lippi • Summer Campaign • Sunny Terrace Half‑Body',
        category: 'brand',
        brand: 'Lippi',
        ...
        images: [
            ...
            { url: 'https://fastly.picsum.photos/id/237/200/300.jpg?hmac=TmmQSbShHz9CdQm0NkEjx1Dyh_Y984R9LpNrpvH2D_U', alt: 'Sneakers' }
        ],
        tags: ['Lippi', 'Summer', 'Terrace', 'Half‑Body', 'Editorial'],
    ...
    },
    {
        ...
        fullText: '(((European male model))), relaxed confident stance, editorial apparel look; background: elegant Mediterranean terrace with beige stone balustrades; soft diffused daylight; half‑body framing; shallow depth of field; crisp focus; HD quality; styling: white sneakers; — ensure hands never occlude the garment; photorealistic, ultra‑detailed.',
        images: [
            { url: 'https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb', alt: 'Terrace 1' },
            { url: 'https://images.unsplash.com/photo-1516822003754-cca485356ecb', alt: 'Terrace 2' },
            { url: 'https://fastly.picsum.photos/id/237/200/300.jpg?hmac=TmmQSbShHz9CdQm0NkEjx1Dyh_Y984R9LpNrpvH2D_U', alt: 'Sneakers' }
        ],
        tags: ['Lippi', 'Summer', 'Terrace', 'Half‑Body', 'Editorial'],
    ...
    {
        id: 'batch-lifestyle-person-holding-1',
        name: 'Lifestyle • Person Holding Product • Outdoor Candid',
        category: 'batch',
        batchType: 'Lifestyle Shoot',
        style: 'Outdoor candid',
        model: 'Midjourney v6',
        fullText: 'Outdoor candid shot of a person naturally holding the product at chest level; golden‑hour street; soft rim light; shallow depth of field; candid smile; realistic skin; DSLR look; 85mm lens bokeh; hands unobstructed; product fully visible.',
        images: [
            { url: 'https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb', alt: 'Candid 1' },
            { url: 'https://images.unsplash.com/photo-1516822003754-cca485356ecb', alt: 'Candid 2' },
